...
class AdicionarPreco extends StatefulWidget {
  const AdicionarPreco({super.key});

  @override
  State<AdicionarPreco> createState() => _AdicionarPrecoState();
}

class _AdicionarPrecoState extends State<AdicionarPreco> {
